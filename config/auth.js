...
module.exports = {
    ...
    'facebookAuth' : {
        ...
        'callbackURL'     : 'http://scrumproject.herokuapp.com/auth/facebook/callback',
    ...
    'twitterAuth' : {
        ...
        'callbackURL'        : 'http://scrumproject.herokuapp.com/auth/twitter/callback'
    },

    'googleAuth' : {
        'clientID'         : '51472290617-v3epql0sbqq9pol0eqevks1efhrgq0j0.apps.googleusercontent.com',
        'clientSecret'     : 'zb6mc-S2WqjHB4dYEuN1sPjg',
        'callbackURL'      : 'http://scrumproject.herokuapp.com/auth/google/callback'
    }
